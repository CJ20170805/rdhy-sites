  ...
  <div id="wrap">
    <div class="detail">
      ...
      <div class="text">
        <h2>软件企业评估</h2>
        <h5>
          “双软认证”是指软件产品评估和软件企业评估；企业申请双软认证除了获得软件企业和软件产品的认证资质，同时也是对企业知识产权的一种保护方式，更可以让企业享受国家提供给软件行业的税收优惠政策。<br>
根据国务院最新公布的国发〔2015〕11号文《国务院关于取消和调整一批行政审批项目等事项决定》中，2015年3月15日取消双软认证的行政审批，改为由各省软件行业协会牵头的“双软评估”。<br>
        </h5>
        <div class="option">
          <div class="item">
            <a href="#">在线咨询</a>
