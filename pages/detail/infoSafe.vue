  ...
  <div id="wrap">
    <div class="detail">
      <div class="img">
        ...
        <ul>
          <li>
            <img ref="firstImg" @click="checkImg($event)" src="~/assets/images/infoSafe.jpg" alt="">
          </li>
        </ul>
      </div>
      <div class="text">
        <h2>信息安全服务资质</h2>
        <h5>
        随着我国信息化和信息安全保障工作的不断深入推进，以应急处理、风险评估、灾难恢复、系统测评、安全运维、安全审计、安全培训和安全咨询等为主要内容的信息安全服务在信息安全保障中的作用日益突出。加强和规范信息安全服务资质管理已成为信息安全管理的重要基础性工作。<br>
        </h5>
    ...
    <div class="main-desc">
      ...
      <div class="tab">
        ...
        <div class="tab-content">
          ...
          信息安全服务资质是信息安全服务机构提供安全服务的一种资格，包括法律地位、资源状况、管理水平、技术能力方面的要求。信息安全服务资质认证是依据国家法律法规、国家标准、行业标准和技术规范，按照认证基本规范及认证规则，对提供信息安全服务机构的信息安全服务资质进行评价。<br>

信息安全服务资质8个认证方向<br>
1、	安全集成服务资质认证； 5、软件安全开发服务资质认证；<br>
2、	安全运维服务资质认证； 6、灾难备份与恢复服务资质认证；<br>
3、风险评估服务资质认证；   7、工业控制安全服务资质认证；<br>
4、应急处理服务资质认证；   8、网络安全审计服务资质认证。<br>


            </p>

            <p class="tit" id="flow">【信息安全服务资质认证的好处】</p>
            <!-- <img src="~/assets/images/soft-lc.png" style="margin-bottom:20px;" alt=""> -->

            <!-- <p class="tit">市场前景</p> -->
            <p class="text">
           
           1、	企业申请并完成信息安全服务资质有助于信息安全服务提供商完善自身管理体系，提高服务质量和水平；<br>
2、	企业申请并完成信息安全服务资质有助于提高需方对信息安全服务提供商的信任度。<br>
